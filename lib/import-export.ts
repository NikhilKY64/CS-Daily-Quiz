  ...
  try {
    ...
    const questionBank: QuestionBank = {
      ...
      metadata: {
        ...
        description: `Exported question bank with ${questions.length} questions`,
  ...
  return new Promise((resolve) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        // Import questions
        const existingQuestions = replaceExisting ? [] : getQuestionBank()
        ...
        const finalQuestions = [...existingQuestions, ...questionsToAdd]
        saveQuestionBank(finalQuestions)
